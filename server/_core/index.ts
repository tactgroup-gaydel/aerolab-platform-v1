...
async function startServer() {
  ...
  // Guard: reject malformed percent-encoded URLs (e.g. a stale browser tab
  // requesting /%VITE_ANALYTICS_ENDPOINT%/umami) so Express routing never
  // throws an uncaught URIError while decoding path params.
